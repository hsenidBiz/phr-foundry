...
These three skills used to ship inside `org-standards`. They moved here so the
...
`/dev-kit:phx-debugger 141827` — or let Claude load it automatically:
...
ADO bug ID with a request to investigate or fix it.
